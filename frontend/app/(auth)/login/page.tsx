    ...
    <div className="container max-w-md py-12">
      <div className="rounded-xl border border-border bg-bg-elev p-8 shadow-lg sm:p-10">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-6 font-display text-3xl font-bold">Bon retour</h1>
          <p className="mt-2 text-sm text-text-soft">Connectez-vous à votre espace pro</p>
        </div>
...
export default function LoginPage() {
  return (
    <Suspense
      fallback={
        <div className="container max-w-md py-12">
          <div className="h-64 animate-pulse rounded-xl border border-border bg-bg-elev" />
        </div>
      }
    >
      <LoginForm />
